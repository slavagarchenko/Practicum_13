def seconds_in_year(date_time_str):
    """
    Convert date and time string from "MM/DD/YYYY HR:MIN:SEC" format
    to "DD.MM.YY HR:MIN:SEC"

    Args:
        date_time_str (str): Date and time string in "MM/DD/YYYY
        HR:MIN:SEC" format

    Returns:
        total_seconds (int): Total seconds passed in the year
    """
    try:
        ...
        days_in_month = {
            1: 31,
            2: 29 if (year % 4 == 0 and year % 100 != 0) or
                     (year % 400 == 0) else 28,
            3: 31,
            4: 30,
            5: 31,
